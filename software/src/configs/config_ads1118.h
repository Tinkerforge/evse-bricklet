...
#define ADS1118_SPI_BAUDRATE           100000
...
#define ADS1118_CLOCK_PASSIVE_LEVEL    XMC_SPI_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_0_DELAY_DISABLED
#define ADS1118_CLOCK_OUTPUT           XMC_SPI_CH_BRG_SHIFT_CLOCK_OUTPUT_SCLK
#define ADS1118_SLAVE                  XMC_SPI_CH_SLAVE_SELECT_0
